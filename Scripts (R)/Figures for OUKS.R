...
max_min <- data.frame(
  "1.Randomization" = c(2303, 0), "2.Integration" = c(2303, 0), "3.Imputation" = c(2303, 0),
  "4.Correction" = c(2303, 0), "5.Annotation" = c(2303, 0), "6.Filtering" = c(2303, 0),
  "7.Normalization" = c(2303, 0), "8.Grouping" = c(2303, 0), "9.Statistics" = c(2303, 0)
)
...
tiff("Logo.tiff", res = 75) # tiff("Graphical Abstract.tiff", res = 75)
radarchart(data, pcol = color, pfcol = scales::alpha(color, 0.5), plwd = 2, plty = 1, cglcol = "grey", cglty = 1, cglwd = 0.8)
mtext(side = 3, line = -13, at = 0, cex = 2.0, "OUKS", col = '#aa1d35', padj = c(0,0), font = 11)
dev.off()

pdf("Logo.pdf") # pdf("Graphical Abstract.pdf")
radarchart(data, pcol = color, pfcol = scales::alpha(color, 0.5), plwd = 2, plty = 1, cglcol = "grey", cglty = 1, cglwd = 0.8)
mtext(side = 3, line = -13, at = 0, cex = 2.0, "OUKS", col = '#aa1d35', padj = c(0,0), font = 11)
dev.off()
