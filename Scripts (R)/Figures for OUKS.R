...
max_min <- data.frame(
  "1.Randomization" = c(2306, 0), "2.Integration" = c(2306, 0), "3.Imputation" = c(2306, 0),
  "4.Correction" = c(2306, 0), "5.Annotation" = c(2306, 0), "6.Filtering" = c(2306, 0),
  "7.Normalization" = c(2306, 0), "8.Grouping" = c(2306, 0), "9.Statistics" = c(2306, 0)
)
