...
VALUE_results <- data.frame(round(c(VALUE_hm,VALUE_knn, VALUE_cart, VALUE_rf1, VALUE_rf2, VALUE_rf3, VALUE_pls, VALUE_pca, VALUE_qrilc), 2))
rownames(VALUE_results) <- c("HM","KNN", "CART", "RF1", "RF2", "RF3", "PLS", "PCA", "QRILC")
...
PA_results <- data.frame(round(c(PA_hm,PA_knn, PA_cart, PA_rf1, PA_rf2, PA_rf3, PA_pls, PA_pca, PA_qrilc), 2))
rownames(PA_results) <- c("HM","KNN", "CART", "RF1", "RF2", "RF3", "PLS", "PCA", "QRILC")
