...
- [Report](https://github.com/plyush1993/OUKS/tree/main/Report%20(Rmd)) in .Rmd, .pdf and .docx formats were provided as an example to reproduce the *OUKS* code script.
